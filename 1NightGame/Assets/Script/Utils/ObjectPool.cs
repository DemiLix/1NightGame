...
public sealed class ObjectPool : MonoBehaviour, ISerializationCallbackReceiver
{
    ...
    public List<List<GameObject>> _values = new List<List<GameObject>>();
    ...
    public void OnAfterDeserialize()
    {
        ...
        //        pooledObjects.Add(_keys[i], _values[i]);
    }
    ...
    static void Recycle(GameObject obj, GameObject prefab)
    {
        if (obj != null)
        {
            ...
            if (instance.isActiveAndEnabled && !isShuttingDown)
            {
